...
moduleForModel('i-i-s-test-project20200713-phone-type', 'Unit | Serializer | i-i-s-test-project20200713-phone-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-test-project20200713-phone-type',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
